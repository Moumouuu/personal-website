      ...
      <section className=" dark:bg-darkBg bg-bg py-20 font-base lg:py-[100px]">
        ...
        <div className="mx-auto flex flex-col w-full justify-center items-center px-5">
          <Accordion
            ...
            answer="The best thing about our product is that it is developed on the latest technologies and is optimized for SEO. It is fast, secure, and reliable."
          />
          <Accordion
            question="How can I get started?"
            answer="You can get started by contacting us and providing us with your requirements. We will then develop a custom solution for you."
          />
          <Accordion
            question="What is the pricing?"
            answer="The pricing depends on the features and requirements of your project. Contact us for a quote."
          />
        </div>
      </section>
    </div>
